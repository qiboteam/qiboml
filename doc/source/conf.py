...
project = "qiboml"
copyright = "2024, The Qibo team"
author = "The Qibo team"

release = qiboml.__version__
...
# custom title
html_title = "Qiboml · v" + release

html_theme_options = {
    "top_of_page_button": "edit",
    "source_repository": "https://github.com/qiboteam/qiboml/",
    "source_branch": "main",
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/qiboteam/qiboml",
            "html": """
...
def run_apidoc(_):
    ...
    package = source.parents[1] / "src" / "qiboml"
